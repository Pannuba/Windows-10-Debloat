...
int main(){
	...
	
	{
		...
		
		{
			...
			if (choice == "y")
				system("powershell -command \"Get-AppxPackage -AllUsers *alarms* | Remove-AppxPackage Get-AppxPackage -AllUsers *people* | Remove-AppxPackage\"");
			...
			if (choice == "y")
				system("powershell -command \"Get-AppxPackage -AllUsers *comm* | Remove-AppxPackage Get-AppxPackage -AllUsers *mess* | Remove-AppxPackage\"");
			...
			if (choice == "y")
				system("powershell -command \"Get-AppxPackage -AllUsers *onenote* | Remove-AppxPackage\"");			system("powershell -command \"Get-AppxPackage -AllUsers *onenote* | Remove-AppxPackage\"");
